...
doc: |
  ...
  [![Build Status](https://travis-ci.org/briandoconnor/dockstore-tool-md5sum.svg)](https://travis-ci.org/CancerCollaboratory/dockstore-tool-bamstats)
  A very, very simple Docker container for the md5sum command.
